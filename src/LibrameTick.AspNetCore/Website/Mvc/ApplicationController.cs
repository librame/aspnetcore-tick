...
namespace Librame.AspNetCore.Web.Applications
{
    ...
    public abstract class ApplicationController : Controller
    {
        ...
        public virtual string GetAreaNavigationPath(Func<ISiteNavigation, NavigationDescriptor> navigationFactory)
        ...
        /// <param name="navigationFactory">指定定位导航的工厂方法。</param>
        /// <returns>返回 <see cref="RedirectResult"/>。</returns>
        public virtual RedirectResult RedirectToAreaNavigation(Func<ISiteNavigation, NavigationDescriptor> navigationFactory)
