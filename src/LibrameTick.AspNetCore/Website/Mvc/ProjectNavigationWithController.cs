...
namespace Librame.AspNetCore.Web.Projects
{
    ...
    /// 带控制器的项目导航。
    /// </summary>
    public class ProjectNavigationWithController : AbstractSiteNavigation
    {
        /// <summary>
        ...
        protected ProjectNavigationWithController(IHtmlLocalizer<SiteNavigationResource> localizer)
            : base(localizer)
        {
            Initialize();
        }
        ...
        protected ProjectNavigationWithController(IHtmlLocalizer<SiteNavigationResource> localizer,
            string area, ISiteNavigation rootNavigation = null)
