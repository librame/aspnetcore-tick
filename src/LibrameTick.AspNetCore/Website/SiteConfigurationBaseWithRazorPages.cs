...
/// </summary>
public class SiteConfigurationBaseWithRazorPages : SiteConfigurationBase,
    IPostConfigureOptions<RazorPagesOptions>
{
    ...
    protected SiteConfigurationBaseWithRazorPages(IApplicationContext context, string area)
        : base(context, area)
    {
    }
